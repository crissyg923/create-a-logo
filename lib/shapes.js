// This files creates the parent shape constructor and the child shape classes of circle, triangle, and square.
// Each class renders the specific shape's code and sets the color.
class Shape {
    constructor(shape) {
        this.shape = shape;
    }
